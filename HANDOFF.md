...
最后更新：2026-09-01
备份检查点（可回滚）：`checkpoint-2026-09-01`（回滚命令见文末）
...
- [ ] 前台网页整体布局和设计（持续渐进调整）
- [ ] 可预约日历系统：主理人忙碌时段要能屏蔽掉、茶室和琴课是两个独立资源（互不冲突，可以同时开放），
      具体怎么展示、怎么让客人自助选时段还没想清楚。想清楚了要不要跟 `booking_requests` 打通再看
...
`checkpoint-2026-08-31-b`、`checkpoint-2026-09-01`
